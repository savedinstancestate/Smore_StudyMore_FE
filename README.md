...
## 🎮 주요 기능
#### 1. 카카오 로그인
- 유저의 카카오 계정을 기반으로 초기 프로필 설정
- 프로필 사진 및 닉네임 변경 가능
#### 2. 스터디 생성 및 모집 기능
- 주제, 참가 인원, 진행 기간을 정해 새로운 스터디 그룹 생성
- 스터디 생성 시 게시판에 모집글 자동 게시
#### 3. 출석하기 기능 
- 스터디원 출결 여부 확인
- 학습 타이머로 스터디 공부왕 랭킹 조회
#### 4. 캘린더 기능
- 스터디 학습일정 생성 및 관리
#### 5. 스터디 문제은행 기능
- 학습한 내용을 문제로 출제
...
#### 6. 목표 설정 기능
- 개인 학습목표 설정
- 진행 전,진행 중,완료 단계로 달성 여부 체크
#### 7. 웹 알림 기능
- 스터디 활동 시 발생된 알림 표시
- 스터디 지원 수락&거절 시 지원자에게 알림 표시
</div>
<br>

## 💡 기획 의도 및 요구사항
### 1. 프로젝트 배경
> 스터디를 모집하고 관리까지 하고 싶다!<br>
> 카카오톡, 디스코드···  함께 사용할 게 너무 많다!<br>
